...
<body>
  ...
  <section>
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header>
        <h2 class="text-xl font-bold text-gray-900 sm:text-3xl">Bouket Money</h2>

        <p class="mt-4 text-justify text-gray-500">
          💵 Hadiah Berkesan dan Berkelas! 💵
          Mau kasih hadiah yang unik, mewah, dan berkesan? Buket uang dari kami solusinya! Dirangkai indah dengan
          sentuhan elegan, buket ini jadi pilihan sempurna untuk berbagai acara spesial. Dari ulang tahun hingga
          pernikahan, hadiah ini pasti mencuri perhatian!
          Yuk, pesan sekarang dan buat penerimanya takjub! 🎁✨
        </p>
      </header>
      ...
      <ul class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <li>
          <a href="#" class="group block overflow-hidden">
            <img src="/pic/money1.jpg" alt=""
              class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]" />

            <div class="relative bg-white pt-3">
              <h3 class="text-xs text-gray-700 group-hover:underline group-hover:underline-offset-4">
                Bouket Money 100k pecahan 20k
              </h3>
        ...
        <li>
          <a href="#" class="group block overflow-hidden">
            <img src="/pic/money2.jpg" alt=""
              class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]" />

            <div class="relative bg-white pt-3">
              <h3 class="text-xs text-gray-700 group-hover:underline group-hover:underline-offset-4">
                Bouket Money 1jt 200k pecahan 100k
              </h3>

              <p class="mt-2">
                <span class="sr-only"> Regular Price </span>

                <span class="tracking-wider text-gray-900"> Rp. 1.300.000 </span>
              </p>
            </div>
          </a>
        </li>
        ...
        <li>
          <a href="/pay" class="group block overflow-hidden">
            <img src="/pic/money3.jpg" alt=""
              class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]" />

            <div class="relative bg-white pt-3">
              <h3 class="text-xs text-gray-700 group-hover:underline group-hover:underline-offset-4">
                Bouket Money 10k pecahan 2k
              </h3>

              <p class="mt-2">
                <span class="sr-only"> Regular Price </span>

                <span class="tracking-wider text-gray-900"> Rp. 25.0000 </span>
              </p>
            </div>
          </a>
        </li>
        ...
        <li>
          <a href="/pay" class="group block overflow-hidden">
            <img src="/pic/money4.jpg" alt=""
              class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]" />

            <div class="relative bg-white pt-3">
              <h3 class="text-xs text-gray-700 group-hover:underline group-hover:underline-offset-4">
                Bouket Money 50k pecahan 5k
              </h3>

              <p class="mt-2">
                <span class="sr-only"> Regular Price </span>

                <span class="tracking-wider text-gray-900"> Rp. 75.000 </span>
              </p>
            </div>
          </a>
        </li>
  ...
  <footer class="bg-rose-700">
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <ul class="mt-12 flex justify-center gap-6 md:gap-8">
        <li>
          <a href="/pay" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:text-gray-700/75">
